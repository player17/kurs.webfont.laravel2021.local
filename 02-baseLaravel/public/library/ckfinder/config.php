...
$config['authentication'] = function () {
    // http://kurs.webfont.laravel2021.local/library/ckfinder/core/connector/php/connector.php?command=Init&lang=ru
    // http://kurs.webfont.laravel2021.local/library/ckfinder/core/connector/php/connector.php?command=FileUpload&lang=ru&type=Images&currentFolder=%2F&hash=d8b46343f954847d&responseType=json
    // https://stackoverflow.com/questions/30665618/ckfinder-authentication-issue-with-laravel-5

    //echo $_SERVER['DOCUMENT_ROOT'] . '/02-baseLaravel/vendor/autoload.php'; die();
    require $_SERVER['DOCUMENT_ROOT'] . '/02-baseLaravel/vendor/autoload.php';
    $app = require_once  $_SERVER['DOCUMENT_ROOT'] . '/02-baseLaravel/bootstrap/app.php';
...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => '/02-baseLaravel/public/uploads/ckfinder/',
